...
class Expenses():
    ...
    def categorize_set_comprehension(self):
        necessary_expenses = {x for x in self.list if x.category == 'Phone' or x.category == 'Auto or Gas' or x.category == 'Classes' or x.category == 'Utilities' or x.category == 'Mortgage'}
